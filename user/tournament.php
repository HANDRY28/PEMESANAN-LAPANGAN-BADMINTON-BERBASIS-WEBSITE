      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-img">
                <img src="../assets/img/tur1.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Badminton Championship 2025</a></h5>
                <p class="fst-italic text-center">25 - 28 Ferbuari 2025</p>
                <p class="card-text">Ayo tunjukkan kemampuanmu di lapangan! Raih pengalaman seru, prestasi gemilang, dan hadiah menarik dalam turnamen ini. Jangan lewatkan kesempatan untuk menjadi bagian dari kompetisi badminton terbaik di Kota Sorong!</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card">
              <div class="card-img">
                <img src="../assets/img/tur2.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Turnamen HUT RI</a></h5>
                <p class="fst-italic text-center">15 - 16 Agustus 2025</p>
                <p class="card-text">Siapkan raketmu dan buktikan kehebatanmu! Ikuti turnamen bergengsi yang mempertemukan pemain terbaik. Raih kemenangan, bangun relasi, dan nikmati semangat kompetisi yang luar biasa!</p>
              </div>
            </div>
